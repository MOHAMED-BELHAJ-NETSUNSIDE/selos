...
export function ClientForm({ client, onSuccess }: ClientFormProps) {
  ...
  const onSubmit = async (data: ClientFormData) => {
    const payload: CreateClientData | UpdateClientData = {
      ...
      longitude: data.longitude !== undefined && data.longitude !== null && !isNaN(data.longitude) ? data.longitude : undefined,
      latitude: data.latitude !== undefined && data.latitude !== null && !isNaN(data.latitude) ? data.latitude : undefined,
